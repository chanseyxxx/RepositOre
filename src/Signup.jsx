    ...
    return (
        <div className="w-full flex items-center justify-center m-10">
            <div className="max-w-md w-full p-6 border border-gray-200 rounded-md shadow-md">
                <h1 className="text-3xl font-jura mb-6 text-black text-center">Crie sua conta RepositORE</h1>
                <h2 className="text-sm font-roboto mb-6 text-secondary text-center">Junte-se à nossa comunidade com acesso ilimitado e gratuito</h2>
                <div className="mt-4 flex flex-col lg:flex-row items-center justify-between">
                    ...
                    <div className="w-full lg:w-1/2 ml-0 lg:ml-2">
                        <button type="button" className="w-full flex justify-center items-center gap-2 bg-white text-sm text-gray-600 p-2 rounded-md hover:bg-gray-50 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200 transition-colors duration-300">
                            ...
                            </svg> Criar com Github
                        </button>
                    </div>
                </div>
                <div className="mt-4 text-sm text-gray-600 text-center">
                    <p>Ou Crie com email</p>
                </div>
                <form action="#" method="POST" className="space-y-4">
                   
                    <div>
                        <label htmlFor="name" className="block text-sm font-medium text-gray-700">Nome</label>
                        <input type="name" id="name" name="name" className="mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300" />
                    </div>
                    <div>
                    ...
                    <div>
                        <button type="submit" className="w-full bg-secondary text-white p-2 rounded-md hover:bg-gray-800  focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300">Criar conta</button>
                    </div>
                </form>
                <div className="mt-4 text-sm text-gray-600 text-center">
                    <p>Já tem conta? <Link to="/Login" className="text-black hover:underline">Entrar</Link></p>
                </div>
            </div>
        </div>
    );
