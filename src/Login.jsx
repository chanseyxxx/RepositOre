    ...
    return (
        <div className="w-full flex items-center justify-center m-10">
            <div className="max-w-md w-full p-6 border border-gray-200 rounded-md shadow-md">
                <h1 className="text-3xl font-jura mb-6 text-black text-center">Entre na sua conta RepositORE</h1>
                ...
                <div className="mt-4 flex flex-col lg:flex-row items-center justify-between">
                    ...
                    <div className="w-full lg:w-1/2 ml-0 lg:ml-2">
                        <button type="button" className="w-full flex justify-center items-center gap-2 bg-white text-sm text-gray-600 p-2 rounded-md hover:bg-gray-50 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200 transition-colors duration-300">
                            ...
                            </svg> Entrar com Github
                        </button>
                    </div>
                </div>
                <div className="mt-4 text-sm text-gray-600 text-center">
                    <p>Ou entre com email</p>
                </div>
                <form action="#" method="POST" className="space-y-4">
                    ...
                    <div>
                        <button type="submit" className="w-full bg-secondary text-white p-2 rounded-md hover:bg-gray-800  focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300">Entrar</button>
                    </div>
                </form>
                <div className="mt-4 text-sm text-gray-600 text-center">
                    <p>Ainda não tem conta? <Link to="/signup" className="text-black hover:underline">Criar conta</Link></p>
                </div>
            </div>
        </div>
    );
